...
## Project Structure
    ...
    ├── selena_toca_life_wo_38653  # Django project configurations
...
1. Clone this repo and `cd selena_toca_life_wo_38653`
...
2. Clone this repo and `cd selena_toca_life_wo_38653`
